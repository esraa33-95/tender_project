...
class CalculateProjectCost
{
    public function handle(ProjectCostUpdated $event)
    {
        ...
        $materialsCost = DB::table('material_rooms')
            ...
            ->join('room_zones', 'room_zones.id', '=', 'material_rooms.room_zone_id')
            ->join('project_rooms', 'project_rooms.room_zone_id', '=', 'room_zones.id')
        ...
        $additionsCost = DB::table('addition_project_rooms')
            ->join('addition_types', 'addition_types.addition_id', '=', 'addition_project_rooms.addition_id')
